...
export default function Reservation() {
  ...
  // ========================================
  // Calculate available tables locally
  // ========================================
  ...
  const availableTables = useMemo(() => {
    ...
    return tables.filter((table) => !blockedTableIds.includes(table.id));
  }, [tables, reservations, date, startTime, endTime]);
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!selectedTableIsAvailable) {
      toast.add({
        ...
        description: "The selected table is no longer available for this time.",
        type: "warning",
      });
    ...
    try {
      ...
      toast.add({
        ...
        description: "Your table reservation has been submitted successfully.",
        type: "success",
      });
    } catch (error) {
  ...
  const handleSearchReservation = async (
    ...
    if (!reservationReference.trim()) {
      toast.add({
        ...
        description: "Please enter your reservation reference.",
        type: "warning",
      });
    ...
    try {
      ...
      const reservation = await fetchReservationByReference(
      ...
      toast.add({
        ...
        description: "Your reservation details have been loaded.",
        type: "success",
      });
    } catch (error) {
      console.error("Failed to find reservation:", error);
        ...
        <div className="mx-auto max-w-lg">
          <Card className="border-slate-800 bg-slate-900">
            <CardContent className="pt-8 text-center">
              ...
              <h2 className="text-2xl font-bold">Reservation Submitted</h2>
              ...
              <div className="mt-6 space-y-3 rounded-xl border border-slate-800 bg-slate-950 p-4 text-left text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span>Table {selectedReservation.tableNumber}</span>
                </div>
    ...
    <div className="min-h-screen bg-slate-950 px-4 py-12 text-slate-100">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-10 text-center">
          ...
          <h1 className="text-4xl font-extrabold">Reserve Your Table</h1>
              ...
              <div className="mt-5 rounded-xl border border-slate-800 bg-slate-950 p-4">
                <div className="mb-4 flex items-center justify-between">
                  ...
                  <span
                    className={`rounded-full px-3 py-1 text-xs font-semibold ${
                      searchedReservation.status === "CONFIRMED"
                        ? "bg-emerald-500/10 text-emerald-400"
                        : searchedReservation.status === "CANCELLED"
                ...
                <div className="grid grid-cols-1 gap-3 text-sm sm:grid-cols-2">
                  <div>
                    ...
                    <p>{searchedReservation.customerName}</p>
                  </div>

                  <div>
                    <p className="text-slate-500">Table</p>

                    <p>Table {searchedReservation.tableNumber}</p>
                  </div>
                    ...
                    <Select value={startTime} onValueChange={setStartTime}>
                      ...
                      <SelectContent className="bg-slate-800">
                        {timeSlots.slice(0, -1).map((time) => (
                          <SelectItem key={time} value={time} className="cursor-pointer hover:bg-slate-500 ">
                            {time}
                          </SelectItem>
                        ))}
                      </SelectContent>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="mt-1 text-xs text-slate-500">
                    Available tables are calculated from existing reservations
                    for your selected date and time.
                  </p>
                </div>
