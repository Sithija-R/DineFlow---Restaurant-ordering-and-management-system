...
export default function Menu() {
  const { menuItems, categories, fetchMenuItems, fetchCategories } =
    useMenuStore();
  ...
  // Total number of pieces in cart
      ...
      <section className="relative overflow-hidden pt-12 pb-16 px-4 sm:px-6 lg:px-8 border-b border-slate-800/80 hero-gradient">
        ...
        <div className="max-w-5xl mx-auto text-center space-y-4">
          ...
          <p className="max-w-2xl mx-auto text-slate-400 text-sm sm:text-base leading-relaxed">
            Fresh artisanal ingredients, handcrafted by master chefs. Choose
            your favorite dishes and order directly to your table or home.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        ...
        <div className="py-4 flex items-center justify-between text-xs text-slate-400">
          ...
          {searchQuery && (
            <span>
              Searching for{" "}
              <strong className="text-orange-400">"{searchQuery}"</strong>
            </span>
          )}
        </div>
        ...
        {filteredItems.length > 0 ? (
          ...
          <div className="text-center py-16 bg-slate-900/40 rounded-3xl border border-slate-800/80 p-8 my-6">
            ...
            <p className="text-xs text-slate-500 mt-1 max-w-sm mx-auto">
              Try adjusting your category filter or search query to discover
              other menu items.
            </p>
      ...
      {totalCartCount > 0 && (
        <div className="fixed bottom-6 right-6 z-30 md:hidden">
          <button
            ...
            className="flex items-center gap-3 px-5 py-3.5 rounded-full bg-gradient-to-r from-orange-500 to-amber-500 text-white font-bold text-sm shadow-2xl shadow-orange-500/50"
          >
